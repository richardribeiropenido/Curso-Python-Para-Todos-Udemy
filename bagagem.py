...
if ((status == 1 and quantidade_malas > 1) or (status == 2 and quantidade_malas > 2) or ((status == 3
                 or status == 4) and quantidade_malas > 3)):
    ...
    if ((comprimento + largura + altura) > 158) or (peso > 32):
        ...
        if quantidade_malas > 1:
            ...
            if ((comprimento + largura + altura) > 158) or (peso > 32):
                print("Você terá que pagar uma taxa de serviços por excesso de bagagem!")
            else:
                if quantidade_malas > 2:
                    ...
                    if ((comprimento + largura + altura) > 158) or (peso > 32):
                        print("Você tera que pagar uma taxa de serviços por excesso de bagagem!")
                    else:
